...
클래스(Class)는 객체를 생성하기 위한 탬플릿입니다. 상태와 메서드(method)를 구성해서 객체를 생성합니다.
...
## 기존 클래스 선언과 비교
ES6(ECMAScript 6)부터 클래스가 문법에 추가되었습니다. 자바스크립트는 프로토타입 기반의(prototype-based) 객체지향 언어입니다. 이전의 ES5(ECMAScript5)에서는 프로트타입, 클로저(Closure)를 사용했습니다.
