...
## 뷰에서의 D3
`select`, `append` 와 같은 D3의 돔 접근 함수는 뷰의 렌더링(rendering) 영역과 겹쳐서 혼란스럽습니다. 이를 해결하기 위해 렌더링 영역은 뷰 템플릿(template)에서 SVG 마크업으로 작성하고 데이터 시각화를 위한 수학적 연산에만 D3 유틸 함수를 사용할 수 있습니다.
