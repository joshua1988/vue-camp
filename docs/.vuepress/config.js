	...
	themeConfig: {
		sidebar: [
			...
			},
			{
				title: 'Nuxt',
				collapsable: false,
				children: ['/nuxt/intro', '/nuxt/ssr', '/nuxt/universal-mode', '/nuxt/folder-structure', '/nuxt/automatic-routing', '/nuxt/layouts', '/nuxt/data-fetching', '/nuxt/store', '/nuxt/deployment'],
			},
			{
				title: 'PWA',
				collapsable: false,
